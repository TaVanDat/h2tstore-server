...
module.exports = function () {
    this.regis = async function (newData, result) {
        const sqlString = 'INSERT INTO Account (Code,Name,Gender,Dob,Email,Phone,Address,UserName,Password,ImageId) VALUES(@code,@name,@gender,@dob,@email,@phone,@address,@userName,@password,@imageId)';
        ...
        return pool.request()
            ...
            .input('imageId', sql.NVarChar, newData.ImageId)
